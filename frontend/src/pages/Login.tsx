...
export default function Login() {
  ...
  return (
    <div className="relative h-full bg-canvas flex items-center justify-center p-6 overflow-hidden">
      {/* Atmospheric background — one faint fuchsia ambient (in-budget). The
          blue glow was removed: blue is not in the Restraint palette. */}
        ...
        <div className="panel rounded-md shadow-panel p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  to="/forgot-password"
                  className="text-[11.5px] text-ink-muted hover:text-sw-fuchsia transition-colors"
                >
                  Forgot?
                </Link>
              </div>
          ...
          <div className="mt-6 pt-5 border-t border-rule text-center">
            <span className="text-[12.5px] text-ink-dim">
              New here?{' '}
              <Link to="/register" className="text-ink hover:text-sw-fuchsia font-medium transition-colors">
                Create an account
              </Link>
            </span>
          </div>
