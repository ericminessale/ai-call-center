...
def agent_conference_webhook():
    ...
    # NOTE: Old takeover SWML mode removed (conference-first architecture).
    # Takeover now uses the standard conference join path below.
    # The initiate_takeover endpoint in calls.py ends the AI B-leg via REST API,
    # and the agent joins the interaction conference using the standard flow.
